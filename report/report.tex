...
D'une part, six valeurs du CAC~40 — TotalEnergies (TTE.PA), LVMH
(MC.PA), BNP~Paribas (BNP.PA), Sanofi (SAN.PA), Schneider Electric
(SU.PA) et le Brent (BZ=F) — permettent une comparaison transversale
...
l'actif. La convergence n'est pas strictement monotone — le prix CRR
